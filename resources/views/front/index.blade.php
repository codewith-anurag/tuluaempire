                    ...
                    <div class="row">
                        <div class="col-xl-7 col-lg-9">
                            <!-- <div class="slider-cont">
                                <h1 data-animation="bounceInLeft" data-delay="1s">Lorem ipsum dolor sit amet.</h1>
                                <p data-animation="fadeInUp" data-delay="1.3s">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Dolorem dolor laborum omnis delectus distinctio? Debitis?</p>
                                <ul>
                                   <li><a data-animation="fadeInUp" data-delay="1.6s" class="main-btn" href="#">Read More</a></li>
                                   <li><a data-animation="fadeInUp" data-delay="1.9s" class="main-btn main-btn-2" href="#">Send Inquiry</a></li>
                                </ul>
                                </div> -->
                        </div>
                    </div>
...
<!--====== NEWS PART START ======-->
<!-- <section id="news-part" class="pt-30 pb-30">
    <div class="container">
       <div class="row">
          <div class="col-md-12">
             <marquee class="maq"> Lorem ipsum dolor sit amet consectetur adipisicing elit. Ab excepturi officiis laudantium commodi, voluptate ea!</marquee>
          </div>
       </div>
    </div>
    </section> -->
...
<!-- <div id="patnar-logo" class="gray-bg">
    <div class="container">
       <div class="row patnar-slied">
          <div class="col-lg-12">
             <div class="singel-patnar text-center">
                <img src="img/dummy-logo.png" alt="Logo">
             </div>
          </div>
          <div class="col-lg-12">
             <div class="singel-patnar text-center">
