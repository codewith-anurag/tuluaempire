                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="header-contact text-lg-left text-center">
                            <ul>
                                <li> <a href="https://www.facebook.com/tuluaempire" class="social"> <i class="fa fa-facebook-f"></i> </a> </li>
                                <li> <a href="#" class="social"> <i class="fa fa-twitter"></i> </a> </li>
                                <li> <a href="https://www.linkedin.com/in/tuluaempire/" class="social"> <i class="fa fa-linkedin" aria-hidden="true"></i> </a> </li>
                                <li> <a href="https://www.instagram.com/tuluaempire/" class="social"> <i class="fa fa-instagram"></i> </a> </li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-6">
                    <div class="header-contact text-lg-right text-center">
                            <ul>
                                 <li> <a href="#" class=""> <i class="fa fa-whatsapp" style="font-size:30px"></i> </a> <span> +91-96015 69549 </span> </li>
                                <li> <a href="#" class="social"> <i class="fa fa-phone"></i> </a> <span> +971 6573 7770 </span> </li>
                                <li> <a href="#" class="social"> <i class="fa fa-mobile"></i> </a> <span> +971 56 717 3839 </span> </li>
                                <li> <a href="#" class="social"> <i class="fa fa-envelope-o"></i> </a> <span> info@tuluaempire.com </span> </li>
                            </ul>
                        </div>
                    </div>
                </div> <!-- row -->
                            ...
                            <div class="col-md-3">
                                ...
                                <ul class="mega-links">
                                    ...
                                    @foreach ($subtheme as $subtheme_list)
                                        <li><a href="{{route('frontthemes',Crypt::encrypt($subtheme_list->id))}}#{{$subtheme_list->subtheme_slug}}">• &nbsp; {{$subtheme_list->title}}</a></li>
                                    @endforeach
                                </ul>
                            </div>
                        @endforeach
